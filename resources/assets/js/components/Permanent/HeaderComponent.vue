                    ...
                    <div class="nav-item dropdown" v-if="$store.getters.user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right dropdown-danger">
                            <li class="dropdown-header">
                                Welcome {{ $store.getters.user ? $store.getters.user.firstame : '' }}
                            </li>
                            <router-link :to="{ path: 'profile', query: { id: $store.getters.user ? $store.getters.user.firstame : '' } }" class="dropdown-item">Profile</router-link>
                            <router-link :to="{ path: 'settings', query: { id: $store.getters.user ? $store.getters.user.firstame : '' } }" class="dropdown-item">Settings</router-link>
                            <div class="dropdown-divider"></div>
                            <form action="/logout" method="POST" id="logoutForm">
                                <input type="hidden" name="_token" :value="token">
                                <button class="btn btn-neutral dropdown-item" type="submit">
    ...
    export default {
        ...
        mounted() {
            ...
            document.getElementById('logoutForm').addEventListener('submit', async function(e) {
                ...
                let self = this
                if(this.$store.getters.facebook !== null) {
